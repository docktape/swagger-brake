...
public class OldApiPathHandlerTest {
    ...
    public void testHandleWorks() {
        ...
        // then
        assertThat(options).extracting(Options::getOldApiPath).isEqualTo(propertyValue);
    }
    ...
    public void testHandleDoesNotDoAnythingIfPropertyIsNull() {
        ...
        underTest.handle(propertyValue, options);
        // then
        assertThat(options).extracting(Options::getOldApiPath).isNull();
    }
    ...
    public void testGetHandledCliOptionIsCorrect() {
        ...
        // then
        assertThat(result).isEqualTo(CliOption.OLD_API_PATH);
    }
}